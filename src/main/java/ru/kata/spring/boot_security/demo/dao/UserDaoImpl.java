...
public class UserDaoImpl implements UserDao {
    ...
    public void updateUser(long id, User userForUpdate) {
        User userForUpdateData = userRepository.findById(id).orElseThrow();
        ...
        userForUpdateData.setPassword(userForUpdate.getPassword());
        userRepository.save(userForUpdateData);
    }
